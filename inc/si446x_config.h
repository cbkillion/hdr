...
// Enable packet handler interrupts, enable specific interrupts: packet sent, packet received, cec error
...
/*
	...
	Setup variable length payload: length value is 2 bytes, MSB first, length is put in FIFO, field 2 is length, field 3 is variable
	Packet length adjust = 0
*/
#define RF_PKT_CRC_CONFIG_12 0x11, 0x12, 0x0B, 0x00, 0x02, 0x05, 0x00, 0xFF, 0xFF, 0x20, 0x32, 0x00, 0x3B, 0x02, 0x00
...
/*
	...
	Setup field 2: 2 bytes long, 4FSK, transmit CRC, check CRC in rx, enable CRC
*/
#define RF_PKT_RX_THRESHOLD_12 0x11, 0x12, 0x0A, 0x0B, 0x30, 0x30, 0x00, 0x08, 0x14, 0xAA, 0x00, 0x02, 0x10, 0x2A


// Setup field 3: up to 1024 bytes long, 4FSK, whitening enabled, transmit CRC, check CRC in rx, enable CRC
#define RF_PKT_FIELD_3_CRC_CONFIG_12 0x11, 0x12, 0x04, 0x15, 0x04, 0x00, 0x10, 0x2A
...
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3B, 0x09, 0x11, 0x11, 0x22, 0x22, 0x20, 0xFF
